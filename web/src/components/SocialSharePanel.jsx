        ...
        <div className="p-4 overflow-hidden relative group/share text-gray-900 dark:text-white">
          ...
          <div className="relative">
            ...
            {canScrollLeft && (
              <button
                onClick={() => scroll('left')}
                className="flex absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 z-10 w-8 h-8 bg-white dark:bg-[#2a2a2a] rounded-full shadow-lg border border-gray-100 dark:border-gray-700 items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#333] transition-all"
              >
            ...
            {canScrollRight && (
              <button
                ...
                className="flex absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 z-10 w-8 h-8 bg-white dark:bg-[#2a2a2a] rounded-full shadow-lg border border-gray-100 dark:border-gray-700 items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-[#333] transition-all"
              >
