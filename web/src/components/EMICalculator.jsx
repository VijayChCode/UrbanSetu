  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-100 dark:border-blue-900/30 p-4 rounded-lg">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300">Property: {propertyName}</p>
        <p className="text-sm text-gray-600 dark:text-gray-300">Price: {formatINR(propertyPrice)}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full p-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-gray-500 dark:text-gray-400">Current market rate: 8.5% - 12%</p>
        </div>
        ...
        <div className="space-y-2">
          ...
          />
          <p className="text-xs text-gray-500 dark:text-gray-400">Common tenure: 15-30 years</p>
        </div>
      </div>

      {/* EMI Results */}
      <div className="bg-green-50/60 dark:bg-green-950/20 border border-green-100 dark:border-green-900/30 p-6 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center">
            <p className="text-sm text-gray-600 dark:text-gray-300 mb-1">Monthly EMI</p>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600 dark:text-gray-300 mb-1">Total Interest</p>
      ...
      {/* EMI Breakdown */}
      <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700/50 p-4 rounded-lg">
        <h5 className="font-semibold text-gray-800 dark:text-gray-200 mb-3">EMI Breakdown</h5>
        <div className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
          <div className="flex justify-between">
            <span>Principal Amount:</span>
            <span className="font-medium text-gray-800 dark:text-gray-200">{formatINR(loanAmount)}</span>
          </div>
          <div className="flex justify-between">
            <span>Interest Amount:</span>
            <span className="font-medium text-gray-800 dark:text-gray-200">{formatINR(totalInterest)}</span>
          </div>
          <div className="flex justify-between border-t border-gray-200 dark:border-gray-700 pt-2">
            <span className="font-semibold text-gray-800 dark:text-gray-200">Total Payment:</span>
            <span className="font-semibold text-gray-900 dark:text-white">{formatINR(totalAmount)}</span>
          </div>
          <div className="flex justify-between">
      ...
      <div className="bg-yellow-50 dark:bg-amber-950/20 border border-yellow-100 dark:border-amber-900/30 p-4 rounded-lg">
        <h5 className="font-semibold text-yellow-800 dark:text-amber-400 mb-2">Important Notes</h5>
        <ul className="text-sm text-yellow-700 dark:text-amber-300 space-y-1">
