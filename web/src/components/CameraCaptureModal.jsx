...
const CameraCaptureModal = ({ isOpen, onClose, onCapture }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/90 backdrop-blur-md flex items-center justify-center z-[100] p-3 sm:p-6 animate-fadeIn">
      <div className="bg-gray-900 border border-gray-800 rounded-3xl shadow-2xl max-w-2xl w-full overflow-hidden flex flex-col relative max-h-[92vh]">
        {/* Modal Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-800/80 bg-gray-900/90 z-10">
          ...
          <button
            ...
            className="w-9 h-9 rounded-full bg-gray-800 hover:bg-gray-700 text-gray-400 hover:text-white flex items-center justify-center transition-colors active:scale-95"
            title="Close Camera"
          >
            <FaTimes size={16} />
          </button>
        ...
        {/* Viewport Box */}
        <div className="relative w-full aspect-[4/3] sm:aspect-video bg-black flex items-center justify-center overflow-hidden">
          {/* Off-screen Canvas */}
            ...
            <>
              {isLoading && (
                <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-black/80 text-white">
                  ...
                  <span className="text-xs font-medium tracking-wide text-gray-300">Initializing Camera...</span>
                </div>
              )}
              <video
                ref={videoRef}
        ...
        <div className="p-4 sm:p-5 bg-gray-950/90 border-t border-gray-800/80 flex items-center justify-between">
          {capturedBlob ? (
            /* Confirmation Actions: Retake or OK */
            <div className="flex items-center justify-between w-full gap-4">
              <button
                onClick={handleRetake}
                className="flex-1 py-3 px-5 rounded-xl bg-gray-800 hover:bg-gray-700 text-gray-200 text-sm font-semibold tracking-wide transition-all active:scale-95 flex items-center justify-center gap-2 border border-gray-700"
              >
              ...
              <button
                ...
                className="flex-1 py-3 px-5 rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-500 hover:via-indigo-500 hover:to-purple-500 text-white text-sm font-bold tracking-wide transition-all shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 active:scale-95 flex items-center justify-center gap-2 border border-white/20"
              >
                <FaCheck size={14} />
            ...
            <div className="flex items-center justify-between w-full px-2 sm:px-6">
              ...
              <button
                ...
                className={`w-16 h-16 rounded-full border-4 border-white p-1 flex items-center justify-center transition-all duration-300 ${
