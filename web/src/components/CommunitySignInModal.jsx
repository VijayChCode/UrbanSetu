...
export default function CommunitySignInModal({
    isOpen,
    onClose,
    action = 'like',
    customTitle,
        ...
        switch (action) {
            case 'like':
                return {
                    ...
                    note: 'To keep discussions authentic and prevent automated spam, reacting to posts requires a verified UrbanSetu account.'
                };
            case 'dislike':
                return {
                    ...
                    note: 'To maintain constructive and respectful community discussions, reactions require a verified UrbanSetu account.'
                };
            case 'reply':
                return {
                    ...
                    note: 'To maintain a safe and supportive neighborhood environment, posting replies requires a signed-in account.'
                };
            case 'comment':
                return {
                    icon: <FaComment className="w-8 h-8 text-blue-600 dark:text-blue-400" />,
                    ...
                    description: customDescription || 'Have something to contribute? Sign in to comment on posts, tag properties using @, and join neighborhood discussions.',
                    note: 'UrbanSetu Community is built on trust and respect. Sign in to contribute to the discussion.'
                };
            case 'post':
                return {
                    ...
                    note: 'All community posts are visible to residents and property seekers. Sign in to publish.'
                };
            default:
                return {
                    ...
                    description: customDescription || 'Sign in to unlock full community interactions including liking, replying, tagging properties, and sharing updates.',
                    note: 'To ensure a verified, safe, and spam-free neighborhood platform, interactions require a signed-in account.'
                };
        }
    };
    ...
    return (
        <div 
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="community-signin-modal-title"
        >
            <div className="max-w-md w-full mx-4 p-6 sm:p-8 rounded-2xl shadow-2xl border-2 border-dashed bg-white/95 dark:bg-gray-800/95 border-blue-200 dark:border-gray-600 backdrop-blur-md transition-all duration-300 relative animate-fade-in-up">
                ...
                <div className="text-center">
                    ...
                    {/* Title */}
                    <h3 
                        id="community-signin-modal-title"
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                        <button
                            ...
                            className="px-6 py-2.5 sm:py-3 rounded-xl font-semibold bg-blue-600 hover:bg-blue-700 text-white transition-all duration-200 hover:shadow-lg hover:scale-105 flex items-center justify-center gap-2 text-sm sm:text-base"
                        >
                    ...
                    <div className="mt-4">
                        <button
                            onClick={onClose}
                            className="text-xs text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition-colors py-1 px-3 rounded"
                        >
                            Maybe Later
                        </button>
                    </div>
