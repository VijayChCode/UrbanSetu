          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto relative animate-slideUp transition-colors">
            ...
            {(!currentUser || activeTab === 'send') ? (
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div className="pt-4 sm:pt-6 border-t border-gray-100 dark:border-gray-800 transition-colors">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3">
                    ...
                    <a 
                      ...
                      className="group flex flex-row sm:flex-col items-center p-3 sm:p-4 bg-gradient-to-br from-blue-50/50 to-indigo-50/10 dark:from-blue-900/10 dark:to-indigo-900/5 hover:from-blue-50 dark:hover:from-blue-900/20 border border-blue-100/50 dark:border-blue-900/20 rounded-2xl text-left sm:text-center transition-all duration-300 transform hover:scale-[1.02] hover:-translate-y-0.5"
                    >
                      <div className="w-10 h-10 rounded-xl bg-blue-500/10 dark:bg-blue-400/10 flex items-center justify-center text-blue-600 dark:text-blue-400 mr-3 sm:mr-0 sm:mb-2 group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
                        <FaEnvelope className="text-base" />
                      </div>
                      <div className="min-w-0 flex flex-col">
                        <span className="text-xs font-bold text-gray-800 dark:text-gray-200 transition-colors">Support & Feedback</span>
                        <span className="text-[10px] text-gray-500 dark:text-gray-400 mt-0.5 sm:mt-1 break-all truncate max-w-full font-medium">urbansetu.noreply@gmail.com</span>
                      </div>
                    </a>
                    ...
                    <a 
                      ...
                      className="group flex flex-row sm:flex-col items-center p-3 sm:p-4 bg-gradient-to-br from-amber-50/50 to-yellow-50/10 dark:from-amber-900/10 dark:to-yellow-900/5 hover:from-amber-50 dark:hover:from-amber-900/20 border border-amber-100/50 dark:border-amber-900/20 rounded-2xl text-left sm:text-center transition-all duration-300 transform hover:scale-[1.02] hover:-translate-y-0.5"
                    >
                      <div className="w-10 h-10 rounded-xl bg-amber-500/10 dark:bg-amber-400/10 flex items-center justify-center text-amber-600 dark:text-amber-400 mr-3 sm:mr-0 sm:mb-2 group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
                      ...
                      <div className="min-w-0 flex flex-col">
                        ...
                        <span className="text-[10px] text-gray-500 dark:text-gray-400 mt-0.5 sm:mt-1 break-all truncate max-w-full font-medium">info.urbansetu@gmail.com</span>
                      </div>
                    </a>
                    ...
                    <a 
                      ...
                      className="group flex flex-row sm:flex-col items-center p-3 sm:p-4 bg-gradient-to-br from-green-50/50 to-emerald-50/10 dark:from-green-900/10 dark:to-emerald-900/5 hover:from-green-50 dark:hover:from-green-900/20 border border-green-100/50 dark:border-green-900/20 rounded-2xl text-left sm:text-center transition-all duration-300 transform hover:scale-[1.02] hover:-translate-y-0.5"
                    >
                      <div className="w-10 h-10 rounded-xl bg-green-500/10 dark:bg-green-400/10 flex items-center justify-center text-green-600 dark:text-green-400 mr-3 sm:mr-0 sm:mb-2 group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
                        <FaShieldAlt className="text-base" />
                      </div>
                      <div className="min-w-0 flex flex-col">
                        <span className="text-xs font-bold text-gray-800 dark:text-gray-200 transition-colors">Accounts & Legal</span>
                        <span className="text-[10px] text-gray-500 dark:text-gray-400 mt-0.5 sm:mt-1 break-all truncate max-w-full font-medium">auth.urbansetu@gmail.com</span>
                      </div>
                    </a>
                  </div>
                </div>
              ...
              <div className="p-6">
                {loadingMessages ? (
                  ...
                  <div className="flex flex-col h-full bg-white dark:bg-transparent">
                    {/* Filters Section */}
                    <div className="p-4 bg-gray-50 dark:bg-gray-800/30 border-b border-gray-100 dark:border-gray-800 flex flex-wrap gap-3 items-center">
                      <div className="relative flex-1 min-w-[180px]">
                        ...
                        <input
                          ...
                          className="w-full pl-9 pr-8 py-1.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-xs text-gray-900 dark:text-white"
                        />
                        {searchTerm && (
                          <button
                      ...
                      <select
                        ...
                        className="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-700 rounded-lg px-2 py-1.5 text-xs outline-none focus:ring-1 focus:ring-blue-500 text-gray-800 dark:text-gray-200"
                      >
                      ...
                      <button
                        ...
                        className="p-2 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors"
                        title={dateSort === 'desc' ? "Newest First" : "Oldest First"}
                      >
                        {dateSort === 'desc' ? (
                          <FaSortAmountDown className="w-3 h-3 text-blue-500" />
                        ) : (
                          <FaSortAmountUp className="w-3 h-3 text-blue-500" />
                        )}
                      </button>
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          title="Start Date"
                        />
                        <span className="text-gray-400 dark:text-gray-600 text-[10px] font-bold">TO</span>
                        <input
                          type="date"
                          value={endDate}
                          max={today}
                    ...
                    <div ref={setMessagesContainerRef} className="space-y-4 max-h-96 overflow-y-auto relative p-4 bg-white dark:bg-transparent">
                      {filteredMessages.length === 0 ? (
                        <div className="text-center py-10">
                          ...
                          <p className="text-sm text-gray-500">No matches found for your criteria</p>
                        </div>
                      ) : (
                        filteredMessages.map((message) => (
                          <div key={message._id} className="border border-gray-100 dark:border-gray-800 rounded-xl p-4 hover:shadow-md transition-all duration-200 bg-white dark:bg-gray-900/40">
                            <div className="flex items-start justify-between mb-3">
                              <div className="flex-1">
                                <div className="flex items-center gap-3 mb-2 flex-wrap">
                                  <h4 className="font-bold text-gray-900 dark:text-white transition-colors">{message.subject}</h4>
                                  {message.ticketId && (
                                    <span className="text-[10px] font-mono bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-2 py-0.5 rounded transition-colors border border-blue-100 dark:border-blue-800">
                                      {message.ticketId}
                                    </span>
                                  )}
                                </div>
                                <div className="flex items-center gap-3 mt-1 text-[11px] text-gray-500 dark:text-gray-400 transition-colors">
                                  <span className="flex items-center gap-1">
                                    <FaClock className="w-2.5 h-2.5" />
                                    {formatDate(message.createdAt)}
                                  </span>
                                  <span className={`px-2 py-0.5 text-[10px] rounded-full font-bold uppercase tracking-wider transition-colors ${message.status === 'replied'
                            ...
                            {/* User Message */}
                            <div className="bg-gray-50 dark:bg-gray-800/40 p-3 rounded-xl mb-3 transition-colors border border-gray-100 dark:border-gray-800">
                              ...
                              {message.attachments && message.attachments.length > 0 && (
                                <div className="mt-3 grid grid-cols-3 gap-2">
                                  {message.attachments.map((url, i) => (
                                    <div key={i} className="block relative aspect-square rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 hover:opacity-90 transition-opacity cursor-pointer shadow-sm" onClick={() => setPreviewImage(url)}>
                            ...
                            {/* Admin Reply */}
                            {message.adminReply && (
                              <div className="bg-green-50/50 dark:bg-green-900/10 p-3 rounded-xl border border-green-200/50 dark:border-green-800/50 transition-colors shadow-sm">
                                <div className="flex items-center justify-between mb-2">
                                  <h6 className="font-bold text-green-700 dark:text-green-400 text-xs uppercase tracking-widest transition-colors">Support Team Reply</h6>
                                  <span className="text-[10px] text-gray-500 dark:text-gray-500 transition-colors">
                                    {formatDate(message.adminReplyAt)}
                                  </span>
                                </div>
                                <p className="text-gray-800 dark:text-gray-200 whitespace-pre-wrap leading-relaxed text-sm transition-colors ring-1 ring-green-500/10 p-2 rounded-lg bg-white/50 dark:bg-gray-800/20">
                                  {message.adminReply}
                                </p>
                              </div>
                            )}
                            ...
                            <div className="flex items-center justify-end mt-2">
                              <button
                                ...
                                className="text-red-500 hover:text-white dark:text-red-400 hover:bg-red-500 transition-all duration-200 p-2 rounded-lg border border-transparent hover:shadow-lg"
