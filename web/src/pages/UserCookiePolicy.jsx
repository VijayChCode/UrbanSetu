  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors duration-300">
      <SEO
        ...
        keywords="UrbanSetu cookie policy, website cookies, manage cookie preferences, user cookie policy"
      />
      {/* Hero Section */}
      ...
      <div className="max-w-5xl mx-auto px-4 py-16 -mt-16 flex flex-col gap-12 relative z-20">
        ...
        <div className="text-center pt-8 border-t border-gray-200 dark:border-gray-800 transition-colors">
          ...
          <div className="flex justify-center gap-6">
            <a href="/user/privacy-policy" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium hover:underline transition-colors">Privacy Policy</a>
            <span className="text-gray-300 dark:text-gray-700">|</span>
            <a href="/user/terms-condition" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium hover:underline transition-colors">Terms of Service</a>
          </div>
        </div>
      </div>
