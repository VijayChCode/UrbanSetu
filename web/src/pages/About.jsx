    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 py-10 px-4 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="max-w-6xl mx-auto space-y-8 relative z-10 animate-fade-in">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-blue-900/10 p-8 text-center transition-colors">
          <h1 className="text-5xl font-extrabold text-blue-700 dark:text-blue-500 mb-6 drop-shadow flex items-center justify-center gap-3">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-blue-900/10 p-8 transition-colors">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {(aboutData.howItWorks ? Object.entries(aboutData.howItWorks) : []).map(([key, section], idx) => (
              <div key={key} className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg p-6 border border-blue-200 dark:border-blue-800">
                ...
                <ul className="space-y-3">
                  {(section.steps || []).map((step, stepIdx) => (
                    <li key={stepIdx} className="flex items-start gap-3 text-slate-700 dark:text-gray-300">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-purple-900/10 p-8 transition-colors">
          ...
          <div className="relative">
            <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-500 to-purple-500 dark:from-blue-600 dark:to-purple-600"></div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-green-900/10 p-8 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {(aboutData.whoWeServe || []).map((audience, idx) => (
              <div key={idx} className="bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-lg p-6 border border-green-200 dark:border-green-800 text-center hover:shadow-md transition-shadow">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-purple-900/10 p-8 transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {(aboutData.teamMembers || []).map((member, idx) => (
                <div key={idx} className="bg-gradient-to-br from-gray-50 to-purple-50 dark:from-gray-800 dark:to-purple-900/20 rounded-lg p-6 border border-gray-200 dark:border-gray-700 text-center hover:shadow-md transition-shadow">
                  ...
                  <p className="text-sm text-slate-600 dark:text-gray-400">{member.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg dark:shadow-green-900/10 p-8 transition-colors">
          ...
          <div className="space-y-4 max-w-4xl mx-auto">
            {(aboutData.faqs || []).map((faq, idx) => (
              <div key={idx} className="border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden transition-colors">
                <button
                  onClick={() => setExpandedFaq(expandedFaq === idx ? null : idx)}
                  className="w-full p-6 text-left bg-gradient-to-r from-gray-50 to-blue-50 dark:from-gray-800 dark:to-blue-900/20 hover:from-blue-50 dark:hover:from-blue-900/30 hover:to-purple-50 dark:hover:to-purple-900/30 transition-all duration-200 flex items-center justify-between"
                >
