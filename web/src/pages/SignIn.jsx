...
export default function SignIn({ bootstrapped, sessionChecked }) {
    ...
    const [showOtpPolicyModal, setShowOtpPolicyModal] = useState(false);
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-6 md:p-8 relative overflow-hidden">
                            ...
                            {loginMethod === "password" ? (
                                ...
                                <form onSubmit={otpSent ? handleOtpLogin : handleSendOTP} className="space-y-5 relative z-10">
                                    ...
                                    {otpSent && (
                                        <div className="flex items-center justify-between text-sm font-medium mt-3 px-1">
                                            <button
                                                type="button"
                                                onClick={() => setShowOtpPolicyModal(true)}
                                                className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors flex items-center gap-1.5 focus:outline-none"
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm transition-all duration-300">
                    <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-2xl max-w-xl w-full border border-gray-200 dark:border-gray-700 animate-fade-in text-left">
                        ...
                        <div className="p-5 pb-3">
                            <div className="bg-blue-50/50 dark:bg-slate-900/40 border border-blue-200/60 dark:border-slate-800 rounded-lg p-5 pb-3 flex flex-col md:flex-row gap-5 items-center md:items-start">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-2xl max-w-xl w-full border border-gray-200 dark:border-gray-700 animate-fade-in text-left">
                        ...
                        <div className="p-5 pb-3">
                            <div className="bg-blue-50/50 dark:bg-slate-900/40 border border-blue-200/60 dark:border-slate-800 rounded-lg p-5 pb-3 flex flex-col md:flex-row gap-5 items-center md:items-start">
                                ...
                                <div className="flex-1">
                                    <ul className="list-disc list-outside ml-5 space-y-3 text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                                        <li>You are allowed a maximum of <strong className="text-gray-900 dark:text-white font-bold">5 OTP requests</strong> within a 15-minute window.</li>
                                        <li>You are allowed a maximum of <strong className="text-gray-900 dark:text-white font-bold">5 incorrect OTP verification attempts</strong> within a 15-minute window.</li>
                                        <li>After either limit is exceeded, your account or IP will be <strong className="text-gray-900 dark:text-white font-bold">locked for 15 minutes</strong>.</li>
                                        <li>During this lock period, you will not be able to request new OTPs or attempt to verify them.</li>
                                        <li>Once the 15-minute lock period has ended, you can try to request and enter a new OTP.</li>
                                        <li>Please ensure you enter the correct 6-digit OTP code sent to your email to avoid getting locked out.</li>
                                    </ul>
                                </div>
                            </div>
