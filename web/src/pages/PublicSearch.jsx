                ...
                <div className="flex flex-col gap-6">
                    ...
                    {loading ? (
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-10 text-center animate-fade-in-up transition-colors duration-300">
                            <img src={isDark ? duckDarkImg : duckImg} alt="No listings found" className={`w-[280px] h-[280px] object-contain mx-auto opacity-90 dark:opacity-80 hover:scale-105 transition-transform duration-500 ${isDark ? 'mix-blend-screen' : ''}`} />
