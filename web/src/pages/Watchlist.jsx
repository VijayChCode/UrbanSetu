    ...
    <div className="bg-gradient-to-br from-purple-50 to-pink-100 dark:from-gray-950 dark:to-gray-900 min-h-screen py-2 sm:py-10 px-1 sm:px-2 md:px-8 overflow-x-hidden transition-colors duration-300">
        ...
        {items.length === 0 ? (
          ...
          <div className={viewMode === 'grid'
            ...
            {filteredAndSortedItems.map((listing) => {
              ...
              return (
                <div key={listing._id} className={`relative group ${isPriceDropped(listing) ? 'ring-2 ring-green-400/70 dark:ring-green-500/50 rounded-xl shadow-lg shadow-green-500/10' : ''} ${isPriceIncreased(listing) ? 'ring-2 ring-red-400/70 dark:ring-red-500/50 rounded-xl shadow-lg shadow-red-500/10' : ''} ${viewMode === 'list' ? 'flex items-center gap-4 p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 w-full overflow-hidden' : ''}`}>
      ...
      <div className="fixed bottom-8 right-8 z-50">
        <button
          ...
          className="relative group w-16 h-16 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-110 flex items-center justify-center bg-gradient-to-r from-pink-500 to-red-500"
