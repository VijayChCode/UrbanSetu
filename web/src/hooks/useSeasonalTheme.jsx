...
export function* getActiveThemes() {
    ...
    const festivals = [
        ...
        { id: 'ramnavami', year: 2026, month: 2, day: 27, window: 0, name: 'Sri Rama Navami', icon: '🏹', sec: '🚩', greet: 'Jai Shri Ram!', effect: 'none', grad: 'bg-gradient-to-r from-orange-500 via-yellow-500 to-red-500', deco: 'bow' },
        { id: 'hanuman', year: 2026, month: 3, day: 2, window: 1, name: 'Hanuman Jayanti', icon: '🙏', sec: '💪', greet: 'Jai Bajrangbali!', effect: 'none', grad: 'bg-gradient-to-r from-orange-600 via-red-500 to-yellow-500', deco: 'mace' },
