        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-2 md:gap-4">
            <button
              ...
              className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-2.5 py-1.5 rounded-md hover:from-blue-600 hover:to-purple-600 transition-all font-semibold shadow-md text-xs sm:text-base sm:px-3 sm:py-1.5 sm:rounded-md w-1/2 sm:w-auto"
            ...
            <button
              ...
              className={`bg-gradient-to-r text-white px-2.5 py-1.5 rounded-md transition-all transform hover:scale-105 shadow-lg font-semibold flex items-center gap-1 sm:gap-2 text-xs sm:text-base w-1/2 sm:w-auto sm:px-4 sm:py-2 sm:rounded-md justify-center ${
                showArchived 
