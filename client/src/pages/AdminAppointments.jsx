                  ...
                  return (
                    <React.Fragment key={c._id || index}>
                      ...
                      <div 
                        ...
                        className={`rounded-2xl px-4 sm:px-5 py-3 text-sm shadow-xl max-w-[90%] sm:max-w-[80%] md:max-w-[70%] break-words relative transform hover:scale-[1.02] transition-transform duration-200 min-h-[60px] ${
                          isMe 
