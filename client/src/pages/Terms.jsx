  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-4">
      ...
      <div className="space-y-6 text-gray-800 text-base">
        <p>Welcome to our Real Estate platform. By using our services, you agree to the following terms and conditions. Please read them carefully. By registering, you must select a role (user or admin) and provide explicit consent to our Terms & Privacy Policy.</p>
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">2. User and Admin Responsibilities</h2>
        <ul className="list-disc ml-6 space-y-2">
          ...
          <li>Admins must act in the best interest of the platform and its users, and may have additional responsibilities (see Admin Terms).</li>
        </ul>
