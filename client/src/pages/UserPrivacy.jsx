...
export default function UserPrivacy() {
  return (
    <div className="max-w-3xl mx-auto py-10 px-4">
      <h1 className="text-3xl font-bold mb-6 text-blue-700">User Privacy Policy</h1>
      <div className="space-y-6 text-gray-800 text-base">
        <p>Your privacy is important to us. This policy explains how we collect, use, and protect your information as a user of our platform.</p>
        <h2 className="text-xl font-semibold mt-6 mb-2">1. Information We Collect</h2>
        <ul className="list-disc ml-6 space-y-2">
          <li>Personal information you provide during registration, including your selected role (user), name, email, and validated mobile number (must be unique and 10 digits).</li>
          <li>Property details, communications, and transaction history.</li>
        ...
        <ul className="list-disc ml-6 space-y-2">
          ...
          <li>To communicate with you about your account, listings, and platform updates.</li>
        ...
        <ul className="list-disc ml-6 space-y-2">
          ...
          <li>You can access, update, or delete your personal information at any time. Deleting your account will remove your data, except where retention is required by law or for legitimate business purposes.</li>
